...
export type { DevToken } from "./contracts/devToken.sol/DevToken";
export { DevToken__factory } from "./factories/contracts/devToken.sol/DevToken__factory";
export type { QuizNFT } from "./contracts/QuizNFT";
export { QuizNFT__factory } from "./factories/contracts/QuizNFT__factory";
